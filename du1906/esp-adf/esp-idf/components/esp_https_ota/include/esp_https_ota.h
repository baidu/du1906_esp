...
#define HTTPS_OTA_DEFAULT_RETRY_TIMES (3)
#define HTTPS_OTA_DEFAULT_INTERVAL_TIME_MS (3000)
...
#define ESP_ERR_HTTPS_OTA_RECONNECT       (ESP_ERR_HTTPS_OTA_BASE + 2)  /* OTA http reconenct */
